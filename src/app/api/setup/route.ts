...
async function seedDemoAccount(user: { id: string; organizationId: string }) {
  ...
  const meetings = [
    ["Riverfront Plaza renewal review", -6, "Elena Marquez and Daniel Cho", 0], ["BS Ventures operating review", -2, "Avery Thompson · Board room", 1], ["Investment committee — Q2 allocation", 4, "Victor Lang · Video conference", 2], ["Foundation grant docket", 7, "Caroline Webb · Foundation office", 3], ["Portfolio risk review", 12, "Morgan Webb · Executive conference room", 0], ["Fleet electrification checkpoint", 16, "Sofia Alvarez · BS Ventures HQ", 1], ["Annual planning offsite", 25, "Blackstone Partners HQ", 2],
  ] as const
